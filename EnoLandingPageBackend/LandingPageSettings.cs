...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null
                               // value when exiting constructor. Consider
...
public class LandingPageSettings {
  ...
  [Required]
  public long RegistrationCloseOffset {
    get;
    set;
  }

  [Required]
  public long CheckInBeginOffset {
    get;
    set;
  }

  [Required]
  public long CheckInEndOffset {
    get;
    set;
  }

  [Required]
  public string HetznerCloudApiToken {
    get;
    set;
  }

  [Required]
  public string HetznerVulnboxType {
    get;
    set;
  }

  [Required]
  public string HetznerVulnboxImage {
    get;
    set;
  }

  [Required]
  public string HetznerVulnboxPubkey {
    get;
    set;
  }

  [Required]
  public string HetznerVulnboxLocation {
    get;
    set;
  }
  ...
  public DateTime GetRegistrationCloseTime() {
    return this.StartTime.AddHours(-this.RegistrationCloseOffset)
        .ToUniversalTime();
  }
