namespace EnoLandingPageBackend.Controllers {
  ...
  public class DataController : Controller {
    ...
    public DataController(LandingPageSettings settings, LandingPageDatabase db,
    ...
    public ActionResult<CtfInfoMessage> CtfInfo() {
      return this.Ok(new CtfInfoMessage(
          this.settings.Title, this.settings.StartTime.ToUniversalTime(),
    ...
    /// Get all Teams.
    /// </summary>
    /// <returns>A Message of Teams participating and not
    ...
    public async Task<ActionResult<TeamsMessage>> Teams() {
      ...
      return this.Json(new TeamsMessage(
          teams.Where(t => t.Confirmed)
              .Select(t => new TeamMessage(t.Name, t.CtftimeId, t.LogoUrl,
                                           t.CountryCode))
              .ToList(),
          teams.Where(t => !t.Confirmed)
              .Select(t => new TeamMessage(t.Name, t.CtftimeId, t.LogoUrl,
    ...
    public async Task<IActionResult> IPs() {
      ...
      return this.File(Encoding.ASCII.GetBytes(string.Join("\n", teams)),
                       "application/force-download", "ips.txt");
    }
  }
}
