namespace EnoLandingPageCore.Messages {
  ...
  public class CtfInfoMessage {
    ...
    public CtfInfoMessage(string title, DateTime startTime,
                          DateTime registrationCloseOffset,
                          DateTime checkInBeginOffset,
                          DateTime checkInEndOffset) {
      this.Title = title;
    ...
    /// </summary>
    /// <value></value>
    public DateTime RegistrationCloseOffset {
      get;
      set;
    }
    ...
    /// </summary>
    /// <value></value>
    public DateTime CheckInBeginOffset {
      get;
      set;
    }
    ...
    /// </summary>
    /// <value></value>
    public DateTime CheckInEndOffset {
      get;
      set;
    }
  }
